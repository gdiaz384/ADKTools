...
set bootWimPath=%winPERoot2%\!%architecture%PEwimPath%version%!\%peFileName%.wim
set origBootWimPath=%winPERoot2%\!%architecture%PEisoPath%version%!\originalWim\winpe%internalVersion%.wim
...
::driver update buggy for WinPE10~, but mostly works
...
::copy
set isoPath=%winPERoot2%\!%architecture%PEisoPath%version%!\WinPEv%internalVersion%_%architecture%.iso
if exist "%isoPath%" del "%isoPath%"
set isoPath=%winPERoot2%\!%architecture%PEisoPath%version%!\WinPE%internalVersion%_%architecture%.iso
set bootWimPathNoExt=%winPERoot2%\!%architecture%PEwimPath%version%!\%peFileName%
...
::this could be used to copy the .wim to somewhere whenever it gets updated
